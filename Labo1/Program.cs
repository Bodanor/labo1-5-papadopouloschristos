...
Coordonnees coord1 = new();
Coordonnees coord2 = new(6, 3);
Coordonnees coord3 = new(coord2);
...
carres.Add(new Carre { Coord = new Coordonnees { x = 3, y = 9 }, Longueur = 4 });
carres.Add(new Carre { Coord = new Coordonnees { x = 6, y = 2 }, Longueur = 2 });
carres.Add(new Carre { Coord = new Coordonnees { x = 1, y = 8 }, Longueur = 7 });
carres.Add(new Carre { Coord = new Coordonnees { x = 5, y = 5 }, Longueur = 3 });
carres.Add(new Carre { Coord = new Coordonnees { x = 2, y = 3 }, Longueur = 5 });
...
formesp.Add(new Carre { Coord = new Coordonnees { x = 5, y = 2 }, Longueur = 6 });
formesp.Add(new Cercle { Coord = new Coordonnees { x = 7, y = 9 }, Rayon = 4 });
formesp.Add(new Rectangle { Coord = new Coordonnees { x = 3, y = 5 }, Longueur = 5, Largeur = 3 });
